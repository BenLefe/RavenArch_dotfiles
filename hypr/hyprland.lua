...
-- Code:10 through Code:19 correspond to the number keys 1 through 0 on the french keyboard. 
-- These bindings allow you to switch between workspaces and move windows to different workspaces using the main modifier key (SUPER) along with the number keys.
...
--mouse:272 is left click, mouse:273 is right click. 
--These bindings allow you to drag and resize windows using the main modifier key (SUPER) along with the left or right mouse button.
...
hl.config({
    ...
    animations = {
        -- enablme or disable animations globally
        enabled = true,
    },

    master = {
        -- Set the default workspace for new windows. Options: "master", "last", "first", "focused"
        new_status = "master",
    },
